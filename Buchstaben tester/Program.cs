...
namespace Buchstaben_tester
{
    class Program
    {
        ...
        /// <summary>
        /// Benutzt nur LINQ, ähnlich aufgebaut wie SQL-Code, um herauszufinden, ob doppelte Buchstaben in einem String sind.
        /// </summary>
        ...
        {
            return (from char chars in Regex.Replace(s.ToLower(), @"[^a-z]", "") //übernimmt den String, welcher hier in Kleinbuchstaben umgewandelt und dann von allen nicht Kleinbuchstaben gereinigt wird. Das Entfernen der Sonderzeichen könnte auch mit einem Where-Filter durchgeführt werden.
                    ...
                    .Count() //Zählt alle Elemente, die im LINQ-Teil davor gefunden wurden.
                    .Equals(0); // Überprüft, ob die Anzahl der Elemente gleich 0 ist.
        }

        /// <summary>
        /// Benutzt LINQ und Lambdas, ähnlich aufgebaut wie Streams mit Lambdas in Java-Code, um herauszufinden, ob doppelte Buchstaben in einem String sind.
        /// </summary>
        /// <param name="s">Zu testender String</param>
        /// <returns>Ergebnis, ob String keine doppelten Buchstaben hat: Ture = keine, False = mind. einen</returns>
        private static bool CharacterTesterLINQ2(string s)
        {
            return Regex.Replace(s.ToLower(), @"[^a-z]", "") //Der String wird in den lower Case geschrieben und es werden alle Elemente herausgefiltert, die keine Kleinbuchstaben sind. Das Entfernen der Sonderzeichen könnte nach der Umwandlung in ein Array auch mit einem Where-Filter durchgeführt werden.
